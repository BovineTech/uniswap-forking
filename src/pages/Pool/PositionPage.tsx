...
const PageWrapper = styled.div`
  ...
  box-shadow: -2px 4px 10px 0px #a0b8c626;
        ...
        <AutoColumn gap="md">
          <AutoColumn gap="sm">
            <RowBetween>
              <Link
                data-cy="visit-pool"
                style={{ textDecoration: 'none', width: 'fit-content', margin: '0.5rem 0' }}
                to="/pools"
              >
                <HoverText>
                  <ChevronsLeft stroke={theme.neutral2} />
                </HoverText>
              </Link>
                ...
                <ActionButtonResponsiveRow>
                  {currency0 && currency1 && feeAmount && tokenId ? (
                    <ButtonGray
                      ...
                      width="fit-content"
                      $borderRadius="50px"
                      style={{ color: 'white', backgroundColor: '#d3d3d3', flex: 1 }}
                    >
