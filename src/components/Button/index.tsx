...
export const ButtonPrimary = styled(BaseButton)`
  ...
  &:focus {
    box-shadow: 0 0 0 1pt ${({ theme }) => darken(0.05, theme.surface2)};
  ...
  &:active {
    box-shadow: 0 0 0 1pt ${({ theme }) => darken(0.1, theme.surface2)};
    background-color: ${({ theme }) => darken(0.1, theme.accent1)};
  }
  &:disabled {
    background-color: ${({ theme, altDisabledStyle, disabled }) =>
      altDisabledStyle ? (disabled ? theme.accent1 : theme.surface4) : theme.surface4};
    color: ${({ altDisabledStyle, disabled, theme }) =>
      altDisabledStyle ? (disabled ? theme.white : theme.surface1) : theme.surface1};
    cursor: auto;
    box-shadow: none;
    border: 1px solid transparent;
    outline: none;
...
const BaseButtonLight = styled(BaseButton)`
  ...
  &:focus {
    box-shadow: 0 0 0 1pt ${({ theme, disabled }) => !disabled && theme.surface2};
...
export const ButtonGray = styled(BaseButton)`
  ...
  color: ${({ $borderRadius }) => $borderRadius ?? '5px'};
  font-size: 16px;
  font-weight: 535;
...
`
export const ButtonGrayUnderline = styled(BaseButton)`
...
export const ButtonSecondary = styled(BaseButton)`
  ...
  &:focus {
    box-shadow: 0 0 0 1pt ${({ theme }) => theme.surface2};
