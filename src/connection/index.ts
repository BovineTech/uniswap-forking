...
import PROJECT_LOGO from 'assets/svg/logo.svg'
...
export const walletConnectV2Connection_withoutProxy: Connection = new (class implements Connection {
  private initializer = (actions: Actions, defaultChainId = ChainId.MAINNET) =>
    new WalletConnectV2({ actions, defaultChainId, onError })
  ...
  get connector() {
    return this.activeConnector[0]
  }

  get hooks() {
    return this.activeConnector[1]
  }
})()
